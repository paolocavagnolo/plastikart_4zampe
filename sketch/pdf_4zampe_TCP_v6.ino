...
void setup() {
  ...
  modbusTCPServer.configureCoils(0x00, 12);
  //0 1 2: mot1 fwd / bwd / stop
  //3 4 5: mot2 fwd / bwd / stop
  //6 7 8: mot3 fwd / bwd / stop
  //9 10 11: mot4 fwd / bwd / stop
...
void loop() {
  ...
  if (digitalRead(EMERG) or !digitalRead(NO_ANOM)) {
    ...
    if (state == 1) { //SW0_AUTO
      ...
      analogWrite(MOT1_PWM, modbusTCPServer.holdingRegisterRead(0));
      analogWrite(MOT2_PWM, modbusTCPServer.holdingRegisterRead(1));
      analogWrite(MOT3_PWM, modbusTCPServer.holdingRegisterRead(2));
      analogWrite(MOT4_PWM, modbusTCPServer.holdingRegisterRead(3));
    
      updateDIR(0,modbusTCPServer.coilRead(0));
      updateDIR(1,modbusTCPServer.coilRead(1));
      updateDIR(2,modbusTCPServer.coilRead(2));

      updateDIR(3,modbusTCPServer.coilRead(3));
      updateDIR(4,modbusTCPServer.coilRead(4));
      updateDIR(5,modbusTCPServer.coilRead(5));

      updateDIR(6,modbusTCPServer.coilRead(6));
      updateDIR(7,modbusTCPServer.coilRead(7));
      updateDIR(8,modbusTCPServer.coilRead(8));

      updateDIR(9,modbusTCPServer.coilRead(9));
      updateDIR(10,modbusTCPServer.coilRead(10));
      updateDIR(11,modbusTCPServer.coilRead(11));
...
void updateDIR(uint8_t index, bool value) {
  ...
  modbusTCPServer.coilWrite(index,0);
}
